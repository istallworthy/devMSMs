...
Below, we specify all reference histories and all comparison histories associated with our two hypotheses. We will specify more specific reference and comparison histories corresponding to each hypothesis in Step 5.   
```{r}
...
#### 5b. Estimate, Compare, & Visualize Model-Predicted Outcome as a Function of Exposure History
