...
data_long_f <- formatLongData(
  data = data_long, exposure = exposure,
...
data_wide_f <- formatWideData(
  data = data_wide, exposure = exposure, exposure_time_pts = exposure_time_pts, outcome = outcome,
  id_var = "ID",
  missing = NA,
  factor_confounders = factor_confounders,
  integer_confounders = integer_confounders,
...
imputed_data <- imputeData(
  data = data_wide_f, exposure = exposure, outcome = outcome,
...
```{r, eval = FALSE}
inspectData(data = data, exposure = exposure, exposure_time_pts = exposure_time_pts, outcome = outcome, ti_conf = ti_conf, tv_conf = tv_conf, comparison = comparison, home_dir = home_dir, verbose = verbose, save.out = save.out)
```
