...
For this example, we create 5 imputed datasets using the default random forest method and 0 iterations (just for illustrative purposes), and assign the output to `data` for use with *devMSMs*. This code takes some time to run. 
