...
![Table 1. Summary of *devMSMs* helper functions.](figures/helper function summary table.png){width=600px}  
...
![Figure 2. Schematic of recommended preliminary steps showing the transformation of the 3 different kinds of starting data (enumerated) to the three kinds of data accepted by *devMSMs*.](figures/prelim steps overview.png){width=900px}
<br>
<br>
