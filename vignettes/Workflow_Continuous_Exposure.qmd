...
print(prebalance_stats, i = 1, t = 1, save.out = save.out)
...
print(prebalance_stats, t = 1, save.out = save.out)
...
summary(prebalance_stats, i = 1, save.out = save.out)

summary(prebalance_stats, save.out = save.out)
...
plot(prebalance_stats, i = 1, t = 1, save.out = save.out)

plot(prebalance_stats, t = 1, save.out = save.out)
...
print(short_formulas, save.out = save.out)
...
plot(weights.cbps, i = 1, save.out = save.out)
...
plot(weights.glm, i = 1, save.out = save.out)
...
plot(weights.gbm, i = 1, save.out = save.out)
```
...
plot(weights.bart, i = 1, save.out = save.out)
```
...
plot(weights.super, i = 1, save.out = save.out)
```
...
summary(balance_stats.cbps, save.out = save.out)

summary(balance_stats.cbps, i = 1, save.out = save.out)
...
plot(balance_stats.cbps, t = 1, save.out = save.out)

plot(balance_stats.cbps, t = 1, i = 1, save.out = save.out)
...
print(balance_stats.cbps, t = 1, save.out = save.out)
...
summary(balance_stats.glm, save.out = save.out)

summary(balance_stats.gbm, save.out = save.out)

summary(balance_stats.bart, save.out = save.out)

summary(balance_stats.super, save.out = save.out)
...
plot(weights.cbps, t = 5, save.out = save.out)
...
print(updated_formulas, save.out = save.out) 
...
plot(final_weights, i = 1, save.out = save.out)
...
We then inspect the trimmed weights from one of the imputed datasets below. The user has the option to supply `save.out` to save plot output to the home directory. 
```{r}

print(trim_weights, i = 1)

plot(trim_weights, i = 1, save.out = save.out)
...
plot(trim_weights.s1, i = 1, save.out = save.out)
...
plot(trim_weights.s2, i = 1, save.out = save.out)
...
summary(final_balance_stats, save.out = save.out)

plot(final_balance_stats, t = 2, save.out = save.out)
...
print(final_balance_stats, save.out = save.out)
...
print(final_balance_stats.s1, save.out = save.out)
...
print(final_balance_stats.s2, save.out = save.out)
...
print(models, i = 2, save.out = save.out)
...
print(models.s1, i = 1, save.out = save.out)
...
print(models.s2, i = 1, save.out = save.out)
...
print(results) # NOTE: need to round p-values for imputed data
...
summary(results, save.out = save.out)
...
plot(results, save.out = save.out)
