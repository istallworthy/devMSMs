...
exclude_covariates=c("Index1", "WAVE2", "WAVE3", 
                     "LIVEVID", "SUBSTRESS", "TANNERALL") #list of characters
...
#MLD: something wrong here; excluded covars still showing up
...
#MLD: when I say "yes" here it gives me an error but works when "no"
...
#MLD: temporarily adding these two lines to fix bug:
ID=object$ID
