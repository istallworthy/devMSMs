...
The most updated version of this package can be found at: https://github.com/istallworthy/devMSMs 
...
```{r}
install.packages(c("devtools", "roxygen2", "rstudioapi"))
...
#load entire R session 
load(paste0(dirname(rstudioapi::getSourceEditorContext()$path),'devMSMsRsession6.2.23.RData'))
...
print(citation("marginaleffects"))
