...
In addition to the core inputs supplied directly to `initMSM()` in Step P4.4, we specify the following (See the Specify Core Inputs vignette for more information including guidance on specifying other core inputs (P3.1-P3.8)) : 
...
We highly recommend first implementing the *Data Preparation Vignette* https://istallworthy.github.io/devMSMs/articles/Preliminary_Steps.html for preparing data starting in different formats (P4.1 - P4.3a).
