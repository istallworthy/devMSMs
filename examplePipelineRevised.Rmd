...
data_long_f <- formatLongData(data = data_long, exposure = exposure, exposure_time_pts = exposure_time_pts, outcome = outcome, 
                              ...
                              factor_confounders = c("state", "TcBlac2","BioDadInHH2","HomeOwnd", "PmBlac2",       
                                                     ...
                                                     "RHasSO"), #list factor variables here
...
files <- list.files(folder, full.names = TRUE, pattern = "\\.csv") #make sure pattern mathes suffix of your data
...
### STEP 2: Creae Simplified Balancing Formulas & Determine Optimal Weighting Method
...
imbalanced_covars <- c("ESETA1.6", "gov_assist", "B18Raw.6") 
