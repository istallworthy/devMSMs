...
inspectData(data, home_dir, exposure, exposure_time_pts, outcome, tv_confounders, ti_confounders, 
            epochs, hi_lo_cut, reference, comparison, verbose = TRUE, save.out = TRUE)
...
#### Create weights with all weighting methods
```{r}
...
#minimum input
weights.ps <- createWeights(home_dir, data, exposure, outcome, tv_confounders, formulas, method = method)
...
### Re-specify weights using optimal weighting method

#### Assess balance using full formulas
```{r}
...
#minimum inputs
final_weights <- createWeights(home_dir, data, exposure, outcome, tv_confounders, formulas, method = method)
