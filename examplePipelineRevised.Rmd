...
names(data_long)[sapply(data_long, class) == "character"]
...
names(data_wide)[sapply(data_wide, class) == "character"]
...
imputed_data <- readRDS("/Users/isabella/Library/CloudStorage/Box-Box/BSL General/MSMs/Tutorial paper/imputations_10.18.23/ESETA1-StrDif_Tot.58_all_imp.rds") # final imputations for empirical example; place your .rds file in your home directory and change the name of file here
...
folder <- "/Users/isabella/Library/CloudStorage/Box-Box/BSL General/MSMs/Tutorial paper/imputations_10.18.23/" # these are final imputations for empirical example; change this to match your local folder
...
names(data[[1]])[sapply(data[[1]], class) == "character"]
...
covariates <- c("ESETA1.6", "InRatioCor.6", "gov_assist","PmEd2", "B18Raw.6") 
...
covariates <- c("ESETA1.6", "state:SmokTotl", "PmAge2:PmBlac2", "ESETA1.6:B18Raw.15:RHasSO.6") #testing interactions
covariates <- c("ESETA1.6", "InRatioCor.6", "gov_assist","PmEd2", "B18Raw.6")  #empirical example
