...
# data_wide <- read.csv("/Users/isabella/Library/CloudStorage/Box-Box/BSL General/MSMs/testing/meriah/imputations/ESETA1-CORTB.154_imp1.csv") #change this to match your folder
...
#optional
maxit <- NA
maxit <- 0 #maximum iterations for imputation (default is 5)
...
imputed_data <- imputeData(data_wide, home_dir, exposure, outcome, 
                           m = m, method = method, maxit = maxit, para_proc = TRUE, read_imps_from_file = "no", 
                           save.out = TRUE)
