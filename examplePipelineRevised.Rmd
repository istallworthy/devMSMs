...
tv_confounders <- c("SAAmylase.6","SAAmylase.15", "SAAmylase.24",
                    "MDI.6", "MDI.15",                                            
                    "RHasSO.6", "RHasSO.15","RHasSO.35", "RHasSO.24","RHasSO.35", "RHasSO.58",                                         
...
# custom <- full_formulas #for testing only 
...
#all inputs
updated_formulas <- createFormulas(home_dir, exposure, exposure_time_pts, outcome, type, ti_confounders, #required
                                   tv_confounders = tv_confounders, concur_conf, keep_conf, #optional
                                   verbose = TRUE, save.out = TRUE) #optional
