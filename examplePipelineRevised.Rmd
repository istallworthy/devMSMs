...
confounder_time_pts <- c(6, 15, 24, 35, 58)
...
formulas <- short_formulas
method  <-  "cbps"; # add best method here
...
mc_method <- # default is Benjamini-Hochburg, ("holm", "hochberg","hommel", "bonferroni", "BH", "BY", "fdr", "none" (see stats::p.adjust() documentation)
