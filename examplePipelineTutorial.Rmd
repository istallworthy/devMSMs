...
object <- msmObject(
  ...
  exposure_labels=c("Income-to-needs-rato"), 
...
object$exclude_covariates=NULL
...
preBalanceChecking(object, wide_long_datasets, full_forms, histories=1)

#create short forms with time-varying covariates only at t-1 for initial weights creation
# short_forms <- createShortForms(object, full_forms, keep=list(exposure=c("ESETA1"),
#                                                          time=c(24),
...
object$weights_method="cbps" #try different weights methods and re-run
...
balance_stats <- assessBalance(object, short_forms, data_for_model_with_weights, weighted=1, histories=0)
...
balance_stats_full <- assessBalance(object, full_forms, data_for_model_with_weights, weighted=1, histories=1)
...
balance_stats_final <- assessBalance(object, full_forms, data_for_model_with_weights, weighted=1, histories=0)
...
all_models <- fitModel(object, data_for_model_with_weights_cutoff, balance_stats_final, model="m3")
...
object$hi_cutoff=0.75
object$lo_cutoff=0.25
