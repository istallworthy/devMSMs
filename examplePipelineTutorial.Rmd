...
#does pre balance checking on full forms to examine initial imbalance; set histories=1 to avoid seeing histories printed
...
object$hi_cutoff=0.60
object$lo_cutoff=0.30
