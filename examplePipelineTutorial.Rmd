...
object <- msmObject(
  ...
  exposure=c("HOMEETA1"), #list of strings
...
balance_stats_final <- assessBalance(object, full_forms, data_for_model_with_weights, weighted=1)
...
all_models <- fitModel(object, data_for_model_with_weights_cutoff, balance_stats_final, model="m0")
...
history_comparisons <- compareHistories(object, data_for_model_with_weights_cutoff, all_models)
