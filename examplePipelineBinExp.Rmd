...
object <- msmObject(
  ...
  exposures=c("INR_bin"), #list of strings
  # exposure_time_pts=c(6, 15, 24, 35, 58, 90, 154), #list of integers
  exposure_time_pts=c(6, 15, 24), #list of integers
 ...
 #### Inclusion Information (optional) ####
  ...
  exclude_covariates=c("Index1", "WAVE2", "WAVE3", "LIVEVID", "SUBSTRESS", "TANNERALL", "AGE.6", "INR"), #list of characters
...
weights_models <- createWeights(object, wide_long_datasets, forms, read_in_from_file="no", twostep="TRUE") 
