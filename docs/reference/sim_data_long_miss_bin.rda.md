...
using the missMethods package. These data contain economic strain
(ESEATA1) as a binary variable.
...
A long data frame of 6,458 observations There are 36 measured variables
collected at one or more of the following time points: 6, 15, 24, 35,
and 58 months.

- "ID" subject id

- "WAVE" age (in months) when data were collected
...
\#' @references DeJoseph, M. L., Sifre, R. D., Raver, C. C., Blair, C.
B., & Berry, D. (2021). Capturing Environmental Dimensions of Adversity
and Resources in the Context of Poverty Across Infancy Through Early
Adolescence: A Moderated Nonlinear Factor Model. Child Development,
n/a(n/a). https://doi.org/10.1111/cdev.13504
